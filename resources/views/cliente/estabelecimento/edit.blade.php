...
<div class="modal-content py-4 text-left px-6">
      ...
      <!--Body-->
      <div class="my-5">
            <form class="bg-white rounded shadow-xl" action="{{ url('estabelecimento-update/'. $estabelecimento->id) }}"
                  ...
                  <div class="py-2">
                        ...
                        <select
                              ...
                              <option @if( $estabelecimento->delivery === $item ) selected @endif
                                    value="{{ $item }}">@if($item == 1) Sim @else Não @endif</option>
                              @endforeach
                        </select>
                  </div>
                  <div class="py-2">
                  ...
                  <div class="py-2">
                        <img src="{{ asset('storage/logos/'. $estabelecimento->logo) }}" id="profile-img-tag"
