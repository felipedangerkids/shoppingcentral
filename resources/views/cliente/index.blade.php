      ...
      <div class="container py-10">
            <div class="grid mx-5  justify-items-center grid-cols-2">
                 ...
                 <a href="{{ url('estabelecimento-show') }}"> <div class="text-center @if ($user->estabelecimento->count() == 0) hidden @endif py-2">
                  ...
                  <div class="text-center @if ($user->estabelecimento->count() == 0) hidden @endif py-2 open-modal-categoria">
                        <img width="100" class="mx-auto" src="{{ url('assets/img/botao.png') }}" alt="">
                        <p class="mt-4 font-bold text-xl uppercase">Cadastrar Categoria</p>
                  </div>
                      <a href="{{ url('categoria-list') }}">
                        <div class="text-center @if ($user->estabelecimento->count() == 0) hidden @endif py-2">
                              <img width="100" class="mx-auto" src="{{ url('assets/img/botao.png') }}" alt="">
                              <p class="mt-4 font-bold text-xl uppercase">Listar Categorias</p>
                        </div>
                  </a>
                  ...
                  <a href="{{ url('product-list') }}">
                        <div class="text-center @if ($user->estabelecimento->count() == 0) hidden @endif py-2">
                              <img width="100" class="mx-auto" src="{{ url('assets/img/botao.png') }}" alt="">
                              <p class="mt-4 font-bold text-xl uppercase">Listar Produto</p>
                        </div>
                  </a>
...
@include('cliente.modal.categoria')
