<div class="modal-categoria hidden fixed w-full h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster"
      ...
      <div
            ...
            <div class="modal-content py-4 text-left px-6">
                  ...
                  <div class="flex justify-between items-center pb-3">
                        ...
                        <div class="categoria-close cursor-pointer z-50">
                  ...
                  <!--Body-->
                  <div class="my-5">
                        <form class="bg-white rounded shadow-xl" action="{{ url('categoria-store') }}" method="POST"
                              enctype="multipart/form-data">
                              @csrf
                              @foreach ($user->estabelecimento as $est)
                              @if ($loop->first)
                              <input name="est_id" type="hidden" value="{{ $est->id }}">
                              @endif
                              @endforeach
                              ...
                              <div class="py-2">
                                    <input class="autoexpand tracking-wide py-2 px-4 mb-3 leading-relaxed appearance-none block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500"
                                          ...
                                          placeholder="Nome da Categoria" aria-label="Name">
                              </div>
