<div class="user-modal hidden fixed w-full h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster"
      ...
      <div
            ...
            <div class="modal-content py-4 text-left px-6">
                  ...
                  <!--Body-->
                  <div class="my-5">
                        <form class="bg-white rounded shadow-xl" method="POST" action="{{ url('user-store') }}"
                              ...
                              <div class="py-2">
                                    <input class="autoexpand tracking-wide py-2 px-4 mb-3 leading-relaxed appearance-none block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500"
                                          id="cus_name" name="email" type="email" required="" placeholder="Email"
                                          aria-label="Name">
                              </div>
                              <div class="py-2">
                                    <input class="autoexpand tracking-wide py-2 px-4 mb-3 leading-relaxed appearance-none block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500"
                                          id="cus_name" name="password" type="password" placeholder="Senha"
                                          aria-label="Name">
                              </div>
                              <div class="py-2">
                                    <input class="autoexpand tracking-wide py-2 px-4 mb-3 leading-relaxed appearance-none block w-full bg-gray-200 border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500"
                                          type="password" placeholder="Confirmar senha" name="password_confirmation"
